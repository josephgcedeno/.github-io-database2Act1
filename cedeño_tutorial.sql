...
-- Started on 2019-12-17 16:43:32
...
--
-- TOC entry 196 (class 1259 OID 1807448)
-- Name: temp; Type: TABLE; Schema: public; Owner: iusvuqwuacxeks
--
...
ALTER TABLE public.temp OWNER TO iusvuqwuacxeks;

--
-- TOC entry 197 (class 1259 OID 1829196)
-- Name: tutorial; Type: TABLE; Schema: public; Owner: iusvuqwuacxeks
--
...
ALTER TABLE public.tutorial OWNER TO iusvuqwuacxeks;

--
-- TOC entry 3824 (class 0 OID 1807448)
-- Dependencies: 196
-- Data for Name: temp; Type: TABLE DATA; Schema: public; Owner: iusvuqwuacxeks
--
...
--
-- TOC entry 3825 (class 0 OID 1829196)
-- Dependencies: 197
-- Data for Name: tutorial; Type: TABLE DATA; Schema: public; Owner: iusvuqwuacxeks
--
...
S1223	Jeff Bezos	T107	MANTEZA, ANDREW E.	2020-01-15	10.00	T52
S1023	Sundar Pichai	T101	UMBUKAN, MERHAMDIN P.	2020-01-08	9.00	T01
S2939	Linus Torvalds	T108	 ASMA, MC KEEN M.	2020-01-15	16.00	T12
S9829	Jack Patrick Dorsey	T109	MAGALLEN, MAYNARD S.	2020-01-12	16.30	T06
S1091	Satya Nadella	T105	BRINA, DENRYL PAUL O.	2020-01-15	10.00	T10
...
S1521	Sundar Pichai	T101		2020-01-15	10.00	T06
S1008	 Susan Wojcicki	T102	VILLARUBIA, JOHN ROCHI M.	2020-04-15	9.00	T52
S2939	 Yves Guillemot	T104		2020-01-06	23.00	T06
S5323	Sundar Pichai	T101	BANLUTA, CJ DIVON P.	2020-01-15	10.00	T06
...
-- Dependencies: 3
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: iusvuqwuacxeks
--

REVOKE ALL ON SCHEMA public FROM postgres;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
GRANT ALL ON SCHEMA public TO iusvuqwuacxeks;
...
GRANT ALL ON LANGUAGE plpgsql TO iusvuqwuacxeks;


-- Completed on 2019-12-17 16:43:52
